...
class BaseRunner(QTMS):
    def __init__(self, ops, **kwargs):
        ...
        self.nutest_branch = kwargs.get("nutest_branch")
    ...
    def update_job_profile_payload(self):
        ...
        for jp_category in BRANCH_METADATA[self.branch].keys():
            kwargs = {'nos_branch': self.nos_branch, 'nos_commit': self.nos_commit,
                      ...
                      'nutest_branch': self.nutest_branch,
                      'obelix_branch': self.obelix_branch
                      }
            ...
            if jp_category == "NAHV-PC":
                ...
                if flag:
                    ...
                    pc_kargs['pc_url'] = BUILD_PC_URL.format(self.pc_branch, self.pc_commit, self.build_type, self.nutest_branch)
                    pc_local_payload = PCPayload(**pc_kargs)
                    print("PC Payload --> {}".format(pc_local_payload.load_payload()))
                    self.job_profiles.extend([{
                        'jps': BRANCH_METADATA[self.branch][jp_category],
            ...
            if jp_category == "NAHV-CATALOG-PE":
                ...
                if flag:
                    ...
                    print("PE Payload --> {}".format(pe_local_payload.load_payload()))
                    self.job_profiles.extend([{
                        'jps': BRANCH_METADATA[self.branch][jp_category],
            ...
            if jp_category == "NAHV-UI":
                ...
                if flag:
                    ...
                    print ("PE_paylod:", pe_ui_local_payload.load_payload() )
                    self.job_profiles.extend([{
                        'jps': BRANCH_METADATA[self.branch][jp_category],
